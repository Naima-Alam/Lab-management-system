...
Route::group(['prefix' => 'payment'], function () {
    Route::get('form/{id}', [PaymentController::class, 'form'])->name('payment.form');
    // Route::get('list',[PaymentController::class,'list'])->name('timeslot.list');
    Route::post('create/{id}', [PaymentController::class, 'create'])->name('payment.create');
});
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => 'admin-auth'], function () {
        ...
        Route::group(['prefix' => 'doctor'], function () {
            ...
            Route::get('appointment.list', [DoctorController::class, 'patientlist'])->name('patient.list');
        });
