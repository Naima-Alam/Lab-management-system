...
<div class="row clearfix">
    <div class="col-lg-10 col-md-7 col-sm-7 col-xs-8">
        <div class="card">
            ...
            <div class="body">
                <form action="{{route('labtechnical.update', $labtechnical->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <input type="text" class="form-control" name="contact_no" value="{{ $labtechnical->contact_no }}">
                        </div>
