...
<ul class="header-dropdown m-r--5">
    <form action="{{route('acreate.update', $appointment->id)}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="time" class="form-control" id="appointment_time" value="{{ $appointment->appointment_time }}">
        </div>
        <div class="form-group">
            <label for="date">Appointment Date:</label>
            <input type="date" class="form-control" id="appointment_date" value="{{ $appointment->appointment_date }}">
        </div>
        <div class="form-group">
