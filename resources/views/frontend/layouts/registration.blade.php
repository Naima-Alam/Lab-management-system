            ...
            <form action="{{ route('register') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group form-float">
                    <div class="form-line">
                        ...
                        <input type="integer" class="form-control" name="contact_no" placeholder="Enter Patient Contact no">
                    </div>
                    <div class="form-group form-float">
                    <div class="form-line">
                        <label class="form-label">Address</label>
                        <input type="string" class="form-control" name="address" placeholder="Enter Patient Address">
                    </div>
                </div>
                <div class="form-group">
