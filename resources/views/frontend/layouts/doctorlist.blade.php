            ...
            @foreach ($doctor_deatils as $data)
                <div class="col-md-4 col-sm-6">
                    <div class="team-thumb wow fadeInUp" data-wow-delay="0.2s">
                        <img src="{{ asset('/uploads/doctor/' . $data->image) }}" class="img-responsive"
                            alt="Doctor Image" width="200" height="200">
                        ...
                        <div class="team-info">
                            ...
                            <div class="team-contact-info">
                                ...
                                <p>
                                    <a class="mj_btn btn btn-success"
                                        href="{{ route('doctor.view', $data->id) }}">View</a>
